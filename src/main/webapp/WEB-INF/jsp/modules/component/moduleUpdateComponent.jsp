...
<form:form  method="POST" action="${CONTEXT}/updateComponent?id=${component.id}" modelAttribute="component" >
...
<div class="form-group">
 ...
 <form:input path = "code" id ="code"  class="form-control"  placeholder="Input code" onkeyup="checkComponentCode()" />
