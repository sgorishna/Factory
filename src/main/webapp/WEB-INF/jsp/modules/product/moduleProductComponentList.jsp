            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${components}" var="component">
                    <tr>
                        ...
                        <td><c:out value="${component.component.code}" /></td>
                        <td><c:out value="${component.componentPercentage}" /></td>

                        <td><a class ="one" href="${CONTEXT}/updateProductComponent?id=${component.id}" > <fmt:message key="UPDATE_COMPONENT" /> </a></td>

                        <td><a class ="one" href="${CONTEXT}/deleteProductComponent?id=${component.id}" onclick="return deleteComponent()"> <fmt:message key="DELETE" /> </a></td>
