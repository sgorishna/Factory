...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header">${product.name} <fmt:message key="ADD_COMPONENT"/></h2>

            <ol class="breadcrumb">

                <li><a href="${CONTEXT}/productComposition?id=${product.id}"><fmt:message
                ...
                <li><a href="${CONTEXT}/productCompoundList?id=${product.id}"><fmt:message key="SHOW_COMPOUNDS"/></a>
                </li>


                <li><a href="${CONTEXT}/productComponentList?id=${product.id}"> <fmt:message
            ...
            <jsp:include page="../modules/product/moduleNewProductComponent.jsp"></jsp:include>
        </div>
