        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div >
                ...
                <div class="input-group" style="float:right; margin-bottom:20px">
                    ...
                    <input type="text" id="search" class="form-control" placeholder="Search for..." aria-label="Left Align">
                </div>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${CONTEXT}/newProduct"><fmt:message key="ADD_NEW_PRODUCT"/></a>
                </li>


            </ol>

            <jsp:include page="../modules/product/moduleProductList.jsp"></jsp:include>
        </div>
