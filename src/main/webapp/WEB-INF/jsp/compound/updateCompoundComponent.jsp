    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${CONTEXT}/compoundComposition?id=${component.compound.id}"><fmt:message
                        key="COMPOUND_COMPOSITION"/></a>
                </li>

                <li><a href="${CONTEXT}/newCompoundCompound?id=${component.compound.id}"><fmt:message
                        key="ADD_COMPOUND"/></a></li>

                <li><a href="${CONTEXT}/newCompoundComponent?id=${component.compound.id}"><fmt:message
                        key="ADD_COMPONENT"/></a>
                </li>

                <li><a href="${CONTEXT}/compoundCompoundList?id=${component.compound.id}"><fmt:message
                        key="SHOW_COMPOUNDS"/></a></li>


                <li><a href="${CONTEXT}/compoundComponentList?id=${component.compound.id}"> <fmt:message
